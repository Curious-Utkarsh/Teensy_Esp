...
void setup() {
  Serial.begin(1500000);       // USB Serial for debugging
  ...
  attachInterrupt(digitalPinToInterrupt(InterruptPin), send_packet, FALLING);
}
...
void loop(){
  if (interruptFlag) 
  {
    ...
    //Serial.println("FALLING EDGE");  // Safe to print here
